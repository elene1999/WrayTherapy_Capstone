...
export async function buildLevelScreen(index: number, jl: JetLagApi): Promise<void> {
    ...
    jl.world.drawPicture({ x: 30, y: 2, width: 4.5, height: 5, img: "flag.png" });

    let exit = jl.world.makeObstacle({ box: true, x: 30, y: 5.50, width: 3, height: 2, img: "" });
        
    let ex = (thisActor: Obstacle, collideActor: Hero) => {
            thisActor.remove(true);
            jl.nav.doChooser(1)
    };
    exit.setHeroCollisionCallback(ex);
    exit.setCollisionsEnabled(false);
            ...
            .then(question_set => {
                ...
                (thisActor: Obstacle, collideActor: Hero) => {
                        ...
                        jl.nav.setPauseSceneBuilder((overlay: OverlayApi) => {
                            ...
                            overlay.addText({ center: true, x: 8, y: 1.75, face: "Arial", color: "#000000", size: 40, z: 0 }, () => question_set[16].question.toString());
                            ...
                            let a11 = overlay.addTapControl({ x: 1.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                                let q_id = question_set[16].id.toString();
                                let q1_end = new Date().getTime();
                                console.log("The question id in a11 is " + q_id);
                                checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[16].optionOne.toString(), 
                                question_set[16].answer.toString(), q_responses, an_entry, q1_start, q1_end);
                                flag = true;
                                return true;

                           });
                            overlay.addText({ center: true, x: 2.75, y: 4.625, face: "Arial", color: "#101010", size: 75, z: 0 }, () => question_set[16].optionOne.toString());
        
                            let a12 = overlay.addTapControl({ x: 5.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                                let q1_end = new Date().getTime();
                                let q_id = question_set[16].id.toString();
                                checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[16].optionTwo.toString(), 
                                question_set[16].answer.toString(), q_responses, an_entry, q1_start, q1_end);
                                return true;
                           });
                            overlay.addText({ center: true, x: 6.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[16].optionTwo.toString());
        
                            let a13 = overlay.addTapControl({ x: 8.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                                let q1_end = new Date().getTime();
                                let q_id = question_set[16].id.toString();
                                checkAnswer(jl, overlay,q_id, a11, a12, a13, a14, question_set[16].optionThree.toString(), question_set[16].answer.toString(), 
                                q_responses, an_entry, q1_start, q1_end);
                                return true;

                           });
                            overlay.addText({ center: true, x: 9.75, y: 4.625, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[16].optionThree.toString());
        
                            let a14 = overlay.addTapControl({ x: 12.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                                let q1_end = new Date().getTime();
                                let q_id = question_set[16].id.toString();
                                checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[16].optionFour.toString(), 
                                question_set[16].answer.toString(), q_responses, an_entry, q1_start, q1_end);
                                console.log("the array is " + q_responses)
                                return true;
                           });
                            overlay.addText({ center: true, x: 13.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[16].optionFour.toString());
                ...
                (thisActor: Obstacle, collideActor: Hero) => {
                    ...
                    jl.nav.setPauseSceneBuilder((overlay: OverlayApi) => {
                        overlay.addImage({ x: 0, y: 0, width: 16, height: 9, img: "black.png" });
                                    ...
                                    overlay.addText({ center: true, x: 8, y: 1.75, face: "Arial", color: "#000000", size: 40, z: 0 }, () => question_set[17].question.toString());
                                    ...
                                    let a11 = overlay.addTapControl({ x: 1.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                                        let q_id = question_set[17].id.toString();
                                        let q2_end = new Date().getTime();
                                        checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[17].optionOne.toString(), 
                                        question_set[17].answer.toString(), q_responses, an_entry, q2_start, q2_end);
                                        return true;

                                });
                                    overlay.addText({ center: true, x: 2.75, y: 4.625, face: "Arial", color: "#101010", size: 75, z: 0 }, () => question_set[17].optionOne.toString());
                
                                    let a12 = overlay.addTapControl({ x: 5.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                                        let q_id = question_set[17].id.toString();
                                        let q2_end = new Date().getTime();
                                        checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[17].optionTwo.toString(), 
                                        question_set[17].answer.toString(), q_responses, an_entry, q2_start, q2_end);
                                        return true;
                                });
                                    overlay.addText({ center: true, x: 6.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[17].optionTwo.toString());
                
                                    let a13 = overlay.addTapControl({ x: 8.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                                        let q_id = question_set[17].id.toString();
                                        let q2_end = new Date().getTime();
                                        checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[17].optionThree.toString(), 
                                        question_set[17].answer.toString(), q_responses, an_entry, q2_start, q2_end);
                                        return true;
                                });
                                    overlay.addText({ center: true, x: 9.75, y: 4.625, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[17].optionThree.toString());
                
                                    let a14 = overlay.addTapControl({ x: 12.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                                        let q_id = question_set[17].id.toString();
                                        let q2_end = new Date().getTime();
                                        checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[17].optionFour.toString(), 
                                        question_set[17].answer.toString(), q_responses, an_entry, q2_start, q2_end);
                                        return true;
                                });
                                    overlay.addText({ center: true, x: 13.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[17].optionFour.toString());
                ...
                (thisActor: Obstacle, collideActor: Hero) => {
                    ...
                    jl.nav.setPauseSceneBuilder((overlay: OverlayApi) => {
                        ...
                        overlay.addText({ center: true, x: 8, y: 1.75, face: "Arial", color: "#000000", size: 40, z: 0 }, () => question_set[18].question.toString());
                        ...
                        let a11 = overlay.addTapControl({ x: 1.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[18].id.toString();
                            let q3_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[18].optionOne.toString(), 
                            question_set[18].answer.toString(), q_responses, an_entry, q3_start, q3_end);
                            return true;

                    });
                        overlay.addText({ center: true, x: 2.75, y: 4.625, face: "Arial", color: "#101010", size: 75, z: 0 }, () => question_set[18].optionOne.toString());

                        let a12 = overlay.addTapControl({ x: 5.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[18].id.toString();
                            let q3_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[18].optionTwo.toString(), 
                            question_set[18].answer.toString(), q_responses, an_entry, q3_start, q3_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 6.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[18].optionTwo.toString());

                        let a13 = overlay.addTapControl({ x: 8.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[18].id.toString();
                            let q3_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[18].optionThree.toString(), 
                            question_set[18].answer.toString(), q_responses, an_entry, q3_start, q3_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 9.75, y: 4.625, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[18].optionThree.toString());

                        let a14 = overlay.addTapControl({ x: 12.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[18].id.toString();
                            let q3_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[18].optionFour.toString(), 
                            question_set[18].answer.toString(), q_responses, an_entry, q3_start, q3_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 13.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[18].optionFour.toString());
                ...
                (thisActor: Obstacle, collideActor: Hero) => {
                    ...
                    jl.nav.setPauseSceneBuilder((overlay: OverlayApi) => {
                        ...
                        overlay.addText({ center: true, x: 8, y: 1.75, face: "Arial", color: "#000000", size: 40, z: 0 }, () => question_set[19].question.toString());
                        ...
                        let a11 = overlay.addTapControl({ x: 1.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[19].id.toString();
                            let q4_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[19].optionOne.toString(), 
                            question_set[19].answer.toString(), q_responses, an_entry, q4_start, q4_end);
                            return true;

                    });
                        overlay.addText({ center: true, x: 2.75, y: 4.625, face: "Arial", color: "#101010", size: 75, z: 0 }, () => question_set[19].optionOne.toString());

                        let a12 = overlay.addTapControl({ x: 5.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[19].id.toString();
                            let q4_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[19].optionTwo.toString(), 
                            question_set[19].answer.toString(), q_responses, an_entry, q4_start, q4_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 6.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[19].optionTwo.toString());

                        let a13 = overlay.addTapControl({ x: 8.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[19].id.toString();
                            let q4_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[19].optionThree.toString(), 
                            question_set[19].answer.toString(), q_responses, an_entry, q4_start, q4_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 9.75, y: 4.625, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[19].optionThree.toString());

                        let a14 = overlay.addTapControl({ x: 12.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[19].id.toString();
                            let q4_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[19].optionFour.toString(), 
                            question_set[19].answer.toString(), q_responses, an_entry, q4_start, q4_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 13.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[19].optionFour.toString());
                ...
                (thisActor: Obstacle, collideActor: Hero) => {
                    ...
                    jl.nav.setPauseSceneBuilder((overlay: OverlayApi) => {
                        ...
                        overlay.addText({ center: true, x: 8, y: 1.75, face: "Arial", color: "#000000", size: 40, z: 0 }, () => question_set[20].question.toString());
                        ...
                        let a11 = overlay.addTapControl({ x: 1.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[20].id.toString();
                            let q5_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[20].optionOne.toString(), 
                            question_set[20].answer.toString(), q_responses, an_entry, q5_start, q5_end);
                            return true;

                    });
                        overlay.addText({ center: true, x: 2.75, y: 4.625, face: "Arial", color: "#101010", size: 75, z: 0 }, () => question_set[20].optionOne.toString());

                        let a12 = overlay.addTapControl({ x: 5.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[20].id.toString();
                            let q5_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[20].optionTwo.toString(), 
                            question_set[20].answer.toString(), q_responses, an_entry, q5_start, q5_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 6.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[20].optionTwo.toString());

                        let a13 = overlay.addTapControl({ x: 8.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[20].id.toString();
                            let q5_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[20].optionThree.toString(), 
                            question_set[20].answer.toString(), q_responses, an_entry, q5_start, q5_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 9.75, y: 4.625, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[20].optionThree.toString());

                        let a14 = overlay.addTapControl({ x: 12.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[20].id.toString();
                            let q5_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[20].optionFour.toString(), 
                            question_set[20].answer.toString(), q_responses, an_entry, q5_start, q5_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 13.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[20].optionFour.toString());
                ...
                (thisActor: Obstacle, collideActor: Hero) => {
                    ...
                    jl.nav.setPauseSceneBuilder((overlay: OverlayApi) => {
                        ...
                        overlay.addText({ center: true, x: 8, y: 1.75, face: "Arial", color: "#000000", size: 40, z: 0 }, () => question_set[21].question.toString());
                        ...
                        let a11 = overlay.addTapControl({ x: 1.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[21].id.toString();
                            let q6_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[21].optionOne.toString(), 
                            question_set[21].answer.toString(), q_responses, an_entry, q6_start, q6_end);
                            return true;

                    });
                        overlay.addText({ center: true, x: 2.75, y: 4.625, face: "Arial", color: "#101010", size: 75, z: 0 }, () => question_set[21].optionOne.toString());

                        let a12 = overlay.addTapControl({ x: 5.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[21].id.toString();
                            let q6_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[21].optionTwo.toString(), 
                            question_set[21].answer.toString(), q_responses, an_entry, q6_start, q6_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 6.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[21].optionTwo.toString());

                        let a13 = overlay.addTapControl({ x: 8.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[21].id.toString();
                            let q6_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[21].optionThree.toString(), 
                            question_set[21].answer.toString(), q_responses, an_entry, q6_start, q6_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 9.75, y: 4.625, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[21].optionThree.toString());

                        let a14 = overlay.addTapControl({ x: 12.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[21].id.toString();
                            let q6_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[21].optionFour.toString(), 
                            question_set[21].answer.toString(), q_responses, an_entry, q6_start, q6_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 13.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[21].optionFour.toString());
                ...
                (thisActor: Obstacle, collideActor: Hero) => {
                    ...
                    jl.nav.setPauseSceneBuilder((overlay: OverlayApi) => {
                        ...
                        overlay.addText({ center: true, x: 8, y: 1.75, face: "Arial", color: "#000000", size: 40, z: 0 }, () => question_set[22].question.toString());
                        ...
                        let a11 = overlay.addTapControl({ x: 1.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[22].id.toString();
                            let q7_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[22].optionOne.toString(), 
                            question_set[22].answer.toString(), q_responses, an_entry, q7_start, q7_end);
                            return true;

                    });
                        overlay.addText({ center: true, x: 2.75, y: 4.625, face: "Arial", color: "#101010", size: 75, z: 0 }, () => question_set[22].optionOne.toString());

                        let a12 = overlay.addTapControl({ x: 5.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[22].id.toString();
                            let q7_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[22].optionTwo.toString(), 
                            question_set[22].answer.toString(), q_responses, an_entry, q7_start, q7_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 6.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[22].optionTwo.toString());

                        let a13 = overlay.addTapControl({ x: 8.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[22].id.toString();
                            let q7_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[22].optionThree.toString(), 
                            question_set[22].answer.toString(), q_responses, an_entry, q7_start, q7_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 9.75, y: 4.625, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[22].optionThree.toString());

                        let a14 = overlay.addTapControl({ x: 12.25, y: 5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[22].id.toString();
                            let q7_end = new Date().getTime();
                            checkAnswer(jl, overlay, q_id, a11, a12, a13, a14, question_set[22].optionFour.toString(), 
                            question_set[22].answer.toString(), q_responses, an_entry, q7_start, q7_end);
                            return true;
                    });
                        overlay.addText({ center: true, x: 13.25, y: 6.125, face: "Arial", color: "#0f0f0f", size: 75, z: 0 }, () => question_set[22].optionFour.toString());
                ...
                (thisActor: Obstacle, collideActor: Hero) => {
                    ...
                    jl.nav.setPauseSceneBuilder((overlay: OverlayApi) => {
                        ...
                        overlay.addText({ center: true, x: 8, y: 1.75, face: "Arial", color: "#000000", size: 40, z: 0 }, () => question_set[23].question.toString());
                        ...
                        let a11 = overlay.addTapControl({ x: 1.75, y: 3.5, width: 2, height: 2, img: "answer_bar.png" }, () => {
                            let q_id = question_set[23].id.toString();
                            let q8_end = new Date().getTime();
                        ...
                        overlay.addText({ center: true, x: 2.75, y: 4.625, face: "Arial", color: "#101010", size: 75, z: 0 }, () => question_set[23].optionOne.toString());
